...
TAAG.displayAbout = function() {
    ...
    TAAG.lastAjax = $.ajax({
        ...
        complete: function(res) {
            var resText = typeof res === 'string' ? res : res.responseText;
            if (TAAG.currentPage !== "about") {return;}
            var ret = resText.replace("\r\n","\n").replace("\r","\n");
            var output = document.getElementById("outputFigDisplay");
            output.className = "";
...
TAAG.displayTestAll = function() {
    ...
    testAllHtml += '<ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-0613074263309085" data-ad-slot="3827566111" data-ad-format="auto" data-full-width-responsive="true"></ins>';
    ...
    testAllHtml += '<ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-0613074263309085" data-ad-slot="5096824876" data-ad-format="auto" data-full-width-responsive="true"></ins>';
...
TAAG.testAllDisplayer = function(fList, txt) {
    ...
    if (fList.length === 0) {
        ...
        footerBlurb.innerHTML = "<div style='width:700px;padding-top:20px;margin:0 auto;font-size:1.4em;'><div style='text-align:center;padding-bottom:20px;'><p>If you're interested in creating your own font, see my <a href='http://patorjk.com/figlet-editor/'>FIGlet Editor</a></p></div></div><div style='clear:both;'></div>";
